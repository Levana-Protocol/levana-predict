...
const useNotifications = () => {
  ...
  const notifySuccess = useCallback((message: SnackbarMessage, options?: OptionsObject<"success">) => {
  ...
  const notifyError = useCallback((error: Error, options?: OptionsObject<"error">) => {
    const shouldSupress = error instanceof AppError && error.level === "suppress"
